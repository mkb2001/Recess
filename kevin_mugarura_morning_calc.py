from tkinter import *
root = Tk()
root.title("Calculator Assignment")
...
def button_equal():
    ...
    if math_operation == "addition":
        e.insert(END, f_num + int(second_number))
...
button_equal = Button(root, text="equal", padx=79, pady=20, command=button_equal)
